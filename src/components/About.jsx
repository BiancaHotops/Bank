...
const About = () => {
    return (
        <>
            <div className="bg-cover bg-center w-full h-screen flex items-center justify-center relative  bg-[url('./assets/about4.png')] z-auto" id="about">
                ...
                <p className="lg:p-14 lg:mt-20 about rounded box-decoration-clone text-center lg:text-3xl text-white lg:w-5/6 p-5 text-2xl ">
