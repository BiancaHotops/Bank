...
const About = () => {
    return (
        <>
            ...
            <div className="px-1 mx-auto max-w-2xl absolute lg:bottom-2/4 lg:ml-36 text-xl sm:left-10 sm:text-4xl w-5/6 lg:top-12 left-7 space-y-5 pt-48 top-[-50px] ml-12 ">
