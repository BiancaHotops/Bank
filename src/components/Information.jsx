...
{/* <div style="background-color:#fff8f4" class="h-full">
    <div class="container mx-auto  lg:px-20" >*/}
        <div class="lg:px-48 pb-40 grid-cols-3 flex lg:flex-row min-h-screen items-center justify-center bg-amber-50 mt-0 z-auto flex-col">
            <div class="border-r border-gray-300 mx-3 lg:pl-12">
                <div class=" py-10 pb-3 mt-72 h-4/6 relative bg-purple-100 group hover:bg-purple-200 cursor-pointer transition ease-out duration-300"> 
                    <div>
                        ...
                        <img src="https://i.ibb.co/FzkhpcD/pngegg.png" alt="https://www.pngegg.com/en/png-nllal/download"></img>
                    </div>
            ...
            <div class="border-r border-gray-300 mx-3 lg:pl-12">
                <div class=" py-10  pb-3 mt-32 h-4/6 relative bg-indigo-100 group hover:bg-indigo-200 cursor-pointer transition ease-out duration-300"> 
                    <div>
                        ...
                        <img src="https://i.ibb.co/JB4GWMJ/pngegg-1.png" alt="https://www.pngegg.com/en/png-zquqj/download"></img>
                    </div>
                   <div class="px-7 mt-20">
            ...
            <div class="border-r border-gray-300 mx-3 lg:pl-12">
                <div class=" py-10 pb-3 mt-5 h-4/6 relative bg-red-100 group hover:bg-red-200 cursor-pointer transition ease-out duration-300"> 
                     <div>
                        ...
                        <img src="https://i.ibb.co/MgnH44p/pngegg-2.png" alt="https://www.pngegg.com/en/png-epwii/download"></img>
                    </div>
                    <div class="px-7 mt-5">
