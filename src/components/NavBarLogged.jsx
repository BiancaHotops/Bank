            ...
            <div className={color ? 'transition-colors duration-300 bg-gray-800 flex w-full justify-between items-center h-20 fixed px-4 z-10 ' : 'flex w-full justify-between items-center h-20 fixed px-4 z-10 text-white bg-gray-800' }>
                <div className={logo ? 'hidden' : 'block lg:mt-0 mt-6'}>
                    ...
                    <ul className='hidden md:flex space-x-10 text-lg'>
                        <li className="line"><a href="#homelogged">HOME</a></li>
                        <li className="line"><a href="#information">INFORMATION</a></li>
                        <li className="line"><a href="#local">LOCAL</a></li>
                        <li className="line"><a href="#cardlogged">CARD</a></li>
                    </ul>
                    ...
                    <div onClick={handleNav} className={nav ? 'h-screen absolute text-white left-0 top-0 w-full bg-black px-7 flex flex-col items-center justify-center text-center' : 'absolute left-[-100%]'}>
                        <ul>
                            <li className='border-b hover:text-pink-700 duration-500'><a href="#homelogged">HOME</a></li>
                            <li className='border-b hover:text-pink-700 duration-500'><a href="#information">INFORMATION</a></li>
                            <li className='border-b hover:text-pink-700 duration-500'><a href="#local">LOCAL</a></li>
                            <li className='border-b hover:text-pink-700 duration-500'><a href="#cardlogged">CARD</a></li>
                            <div className='flex flex-col'>
                               
                            <Link to='/'><button className=' my-4 px-6 py-2 text-rose-600 hover:text-white transition-colors duration-300 rounded-lg border-2 border-rose-600 hover:bg-rose-600 rounded-lg shadow-xl'>GO OUT</button></Link> 
