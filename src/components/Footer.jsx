...
import name from '../assets/hbank.png'
                    ...
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            <div className="flex items-center justify-center">
                                <img src={logoo} className="w-[40px] mt-[-10px]" />

                            </div>
                            <img src={name} className="w-[140px] h-[25px]" />
                        </a>
                    </div>
                    <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4 ">
                        <div className="">
                            <h3 className="tracking-wide uppercase dark:text-gray-50">HBANK</h3>
                            <ul >
                                ...
                                <li className='mt-6 p-0'>
                                    <a className='linkk' rel="noopener noreferrer" href="#">APP</a>
                                </li>
                            </ul>
                        </div>
