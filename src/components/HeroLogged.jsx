...
const HeroLogged = () => {
    return (
        <>
            <div className="bg-cover lg:bg-center w-full h-screen relative bg-[url('./assets/img1.jpg')] z-auto bg-[left_-38rem_top_1rem]" id="homelogged">
                <div className="px-1 lg:top-2/4 mx-auto max-w-3xl absolute  left-5 text-xl text-5xl sm:left-10 space-y-5 top-2/3">
                    ...
                    <p className="rounded box-decoration-clone lg:bg-gradient-to-r lg:from-rose-800 lg:to-rose-500 lg:text-4xl text-white lg:ml-0 ml-8 lg:w-2/3 w-[280px] p-2 text-3xl bg-gradient-to-r from-rose-800 to-rose-500 ">The bank for your business</p>
                </div>
            </div>
